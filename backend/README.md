...
## Project Structure
    ...
    ├── morning_wildflower_39489  # Django project configurations
...
1. Clone this repo and `cd morning_wildflower_39489`
...
2. Clone this repo and `cd morning_wildflower_39489`
